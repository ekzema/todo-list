...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference('Todolist.count') do
      post todolists_url, params: { todolist: { name: @todolist.name, priority: @todolist.priority, user_id: @todolist.user_id } }
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { name: @todolist.name, priority: @todolist.priority, user_id: @todolist.user_id } }
